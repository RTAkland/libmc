...
internal abstract class Packet {
    ...
    suspend fun writePayload(buf: BytesBuffer) {
    ...
    companion object Codec {
        suspend fun decode(channel: ReadChannel): ResponsePacket {
...
internal suspend fun WriteChannel.sendPacket(packet: Packet) {
    val buf = BytesBuffer()
...
internal suspend fun ReadChannel.readPacket(): ResponsePacket = Packet.decode(this)