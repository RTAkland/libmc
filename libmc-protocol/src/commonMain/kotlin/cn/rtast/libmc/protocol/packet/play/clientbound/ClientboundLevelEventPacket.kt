...
public data class ClientboundLevelEventPacket(
    ...
    internal companion object Codec : PacketCodec<ClientboundLevelEventPacket> {
        override suspend fun encode(buffer: BytesBuffer, value: ClientboundLevelEventPacket) {}
        override suspend fun decode(buffer: BytesBuffer): ClientboundLevelEventPacket {
